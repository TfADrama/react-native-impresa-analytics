...
Pod::Spec.new do |spec|
  ...
  spec.source = { :git => 'https://github.com/google/double-conversion.git',
                  :tag => "v#{spec.version}" }
  spec.module_name = 'RNImpresaNetscope'
  spec.header_dir = 'react-native-impresa-netscope'
  spec.source_files = 'react-native-impresa-netscope/ios/**/*.{h,m}'
